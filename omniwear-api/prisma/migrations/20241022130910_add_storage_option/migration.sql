...
INSERT INTO "new_Dataset" ("created_at", "dataset_id", "health_features", "health_reading_frequency", "health_reading_interval", "inertial_collection_duration_seconds", "inertial_collection_frequency", "inertial_features", "inertial_sleep_duration_seconds", "updated_at") SELECT "created_at", "dataset_id", "health_features", "health_reading_frequency", "health_reading_interval", "inertial_collection_duration_seconds", "inertial_collection_frequency", "inertial_features", "inertial_sleep_duration_seconds", "updated_at" FROM "Dataset";
DROP TABLE "Dataset";
